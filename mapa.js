...
function sucesso(position){
    ...
    marker[0].fone = "+55 (51) 3455-1858";
    marker[0].bindPopup("<b>" + marker[0].nome + "</b>" + "<br>" + "<spam>"+ marker[0].gestao +"</spam>" + "<br>" + "<spam>" + marker[0].ensino + "</spam>" + "<br>" + "<spam>" + marker[0].fone + "</spam>");
    ...
    marker[1].fone = "(51) 33110522";
    marker[1].bindPopup("<b>" + marker[1].nome + "</b>" + "<br>" + "<spam>"+ marker[1].gestao +"</spam>" + "<br>" + "<spam>" + marker[1].ensino + "</spam>" + "<br>" + "<spam>" + marker[1].fone + "</spam>");
    ...
    marker[2].fone = "(51) 30862200";
    marker[2].bindPopup("<b>" + marker[2].nome + "</b>" + "<br>" + "<spam>"+ marker[2].gestao +"</spam>" + "<br>" + "<spam>" + marker[2].ensino + "</spam>" + "<br>" + "<spam>" + marker[2].fone + "</spam>");
    ...
    marker[4].fone = "(51) 30862100";
    marker[4].bindPopup("<b>" + marker[4].nome + "</b>" + "<br>" + "<spam>"+ marker[4].gestao +"</spam>" + "<br>" + "<spam>" + marker[4].ensino + "</spam>" + "<br>" + "<spam>" + marker[4].fone + "</spam>");
    ...
    marker[5].fone = "(51) 33206200";
    marker[5].bindPopup("<b>" + marker[5].nome + "</b>" + "<br>" + "<spam>"+ marker[5].gestao +"</spam>" + "<br>" + "<spam>" + marker[5].ensino + "</spam>" + "<br>" + "<spam>" + marker[5].fone + "</spam>");
    ...
    marker[6].fone = "(51) 32355000";
    marker[6].bindPopup("<b>" + marker[6].nome + "</b>" + "<br>" + "<spam>"+ marker[6].gestao +"</spam>" + "<br>" + "<spam>" + marker[6].ensino + "</spam>" + "<br>" + "<spam>" + marker[6].fone + "</spam>");
    ...
    marker[7].fone = "(51) 33285035";
    marker[7].bindPopup("<b>" + marker[7].nome + "</b>" + "<br>" + "<spam>"+ marker[7].gestao +"</spam>" + "<br>" + "<spam>" + marker[7].ensino + "</spam>" + "<br>" + "<spam>" + marker[7].fone + "</spam>");
    ...
    marker[8].fone = "(51) 30930070";
    marker[8].bindPopup("<b>" + marker[8].nome + "</b>" + "<br>" + "<spam>"+ marker[8].gestao +"</spam>" + "<br>" + "<spam>" + marker[8].ensino + "</spam>" + "<br>" + "<spam>" + marker[8].fone + "</spam>");
    ...
    marker[9].fone = "+55 (51) 3382-6000";
    marker[9].bindPopup("<b>" + marker[9].nome + "</b>" + "<br>" + "<spam>"+ marker[9].gestao +"</spam>" + "<br>" + "<spam>" + marker[9].ensino + "</spam>" + "<br>" + "<spam>" + marker[9].fone + "</spam>");
    ...
    marker[10].fone = "(sem info)";
    marker[10].bindPopup("<b>" + marker[10].nome + "</b>" + "<br>" + "<spam>"+ marker[10].gestao +"</spam>" + "<br>" + "<spam>" + marker[10].ensino + "</spam>" + "<br>" + "<spam>" + marker[10].fone + "</spam>");
    ...
    marker[11].fone = "(sem info)";
    marker[11].bindPopup("<b>" + marker[11].nome + "</b>" + "<br>" + "<spam>"+ marker[11].gestao +"</spam>" + "<br>" + "<spam>" + marker[11].ensino + "</spam>" + "<br>" + "<spam>" + marker[11].fone + "</spam>");
    ...
    marker[12].fone = "(51) 32505882";
    marker[12].bindPopup("<b>" + marker[12].nome + "</b>" + "<br>" + "<spam>"+ marker[12].gestao +"</spam>" + "<br>" + "<spam>" + marker[12].ensino + "</spam>" + "<br>" + "<spam>" + marker[12].fone + "</spam>");
    ...
    marker[13].fone = "(51) 30134540";
    marker[13].bindPopup("<b>" + marker[13].nome + "</b>" + "<br>" + "<spam>"+ marker[13].gestao +"</spam>" + "<br>" + "<spam>" + marker[13].ensino + "</spam>" + "<br>" + "<spam>" + marker[13].fone + "</spam>");
    ...
    marker[14].fone = "(51) 33489733";
    marker[14].bindPopup("<b>" + marker[14].nome + "</b>" + "<br>" + "<spam>"+ marker[14].gestao +"</spam>" + "<br>" + "<spam>" + marker[14].ensino + "</spam>" + "<br>" + "<spam>" + marker[14].fone + "</spam>");
    ...
    marker[15].fone = "(51) 33986631";
    marker[15].bindPopup("<b>" + marker[15].nome + "</b>" + "<br>" + "<spam>"+ marker[15].gestao +"</spam>" + "<br>" + "<spam>" + marker[15].ensino + "</spam>" + "<br>" + "<spam>" + marker[15].fone + "</spam>");
    ...
    marker[16].fone = "(sem info)";
    marker[16].bindPopup("<b>" + marker[16].nome + "</b>" + "<br>" + "<spam>"+ marker[16].gestao +"</spam>" + "<br>" + "<spam>" + marker[16].ensino + "</spam>" + "<br>" + "<spam>" + marker[16].fone + "</spam>");
    ...
    marker[17].fone = "(51) 32231078";
    marker[17].bindPopup("<b>" + marker[17].nome + "</b>" + "<br>" + "<spam>"+ marker[17].gestao +"</spam>" + "<br>" + "<spam>" + marker[17].ensino + "</spam>" + "<br>" + "<spam>" + marker[17].fone + "</spam>");
    ...
    marker[18].fone = "(51) 33365898";
    marker[18].bindPopup("<b>" + marker[18].nome + "</b>" + "<br>" + "<spam>"+ marker[18].gestao +"</spam>" + "<br>" + "<spam>" + marker[18].ensino + "</spam>" + "<br>" + "<spam>" + marker[18].fone + "</spam>");
    ...
    marker[19].fone = "(51) 33987815";
    marker[19].bindPopup("<b>" + marker[19].nome + "</b>" + "<br>" + "<spam>"+ marker[19].gestao +"</spam>" + "<br>" + "<spam>" + marker[19].ensino + "</spam>" + "<br>" + "<spam>" + marker[19].fone + "</spam>");
    ...
    marker[20].fone = "(51) 33282810";
    marker[20].bindPopup("<b>" + marker[20].nome + "</b>" + "<br>" + "<spam>"+ marker[20].gestao +"</spam>" + "<br>" + "<spam>" + marker[20].ensino + "</spam>" + "<br>" + "<spam>" + marker[20].fone + "</spam>");
    ...
    marker[21].fone = "(51) 33573300";
    marker[21].bindPopup("<b>" + marker[21].nome + "</b>" + "<br>" + "<spam>"+ marker[21].gestao +"</spam>" + "<br>" + "<spam>" + marker[21].ensino + "</spam>" + "<br>" + "<spam>" + marker[21].fone + "</spam>");
    ...
    marker[22].fone = "(51) 3233-6323";
    marker[22].bindPopup("<b>" + marker[22].nome + "</b>" + "<br>" + "<spam>"+ marker[22].gestao +"</spam>" + "<br>" + "<spam>" + marker[22].ensino + "</spam>" + "<br>" + "<spam>" + marker[22].fone + "</spam>");
    ...
    marker[23].fone = "(51) 30947600";
    marker[23].bindPopup("<b>" + marker[23].nome + "</b>" + "<br>" + "<spam>"+ marker[23].gestao +"</spam>" + "<br>" + "<spam>" + marker[23].ensino + "</spam>" + "<br>" + "<spam>" + marker[23].fone + "</spam>");
    ...
    marker[24].fone = "+55 (51) 3288-4119";
    marker[24].bindPopup("<b>" + marker[24].nome + "</b>" + "<br>" + "<spam>"+ marker[24].gestao +"</spam>" + "<br>" + "<spam>" + marker[24].ensino + "</spam>" + "<br>" + "<spam>" + marker[24].fone + "</spam>");
    ...
    marker[25].fone = "(sem info)";
    marker[25].bindPopup("<b>" + marker[25].nome + "</b>" + "<br>" + "<spam>"+ marker[25].gestao +"</spam>" + "<br>" + "<spam>" + marker[25].ensino + "</spam>" + "<br>" + "<spam>" + marker[25].fone + "</spam>");
    ...
    marker[26].fone = "(51) 32174427";
    marker[26].bindPopup("<b>" + marker[26].nome + "</b>" + "<br>" + "<spam>"+ marker[26].gestao +"</spam>" + "<br>" + "<spam>" + marker[26].ensino + "</spam>" + "<br>" + "<spam>" + marker[26].fone + "</spam>");
    ...
    marker[27].fone = "+55 (51) 3268-2236";
    marker[27].bindPopup("<b>" + marker[27].nome + "</b>" + "<br>" + "<spam>"+ marker[27].gestao +"</spam>" + "<br>" + "<spam>" + marker[27].ensino + "</spam>" + "<br>" + "<spam>" + marker[27].fone + "</spam>");
    ...
    marker[30].fone = "(51) 3284-1200";
    marker[30].bindPopup("<b>" + marker[30].nome + "</b>" + "<br>" + "<spam>"+ marker[30].gestao +"</spam>" + "<br>" + "<spam>" + marker[30].ensino + "</spam>" + "<br>" + "<spam>" + marker[30].fone + "</spam>");
    ...
    marker[31].fone = "(sem info)";
    marker[31].bindPopup("<b>" + marker[31].nome + "</b>" + "<br>" + "<spam>"+ marker[31].gestao +"</spam>" + "<br>" + "<spam>" + marker[31].ensino + "</spam>" + "<br>" + "<spam>" + marker[31].fone + "</spam>");
    ...
    marker[32].ensino = ["Fundamental"];
    marker[32].fone = "(51) 33364509";
    marker[32].bindPopup("<b>" + marker[32].nome + "</b>" + "<br>" + "<spam>"+ marker[32].gestao +"</spam>" + "<br>" + "<spam>" + marker[32].ensino + "</spam>" + "<br>" + "<spam>" + marker[32].fone + "</spam>");
    ...
    marker[33].fone = "(51) 33114968";
    marker[33].bindPopup("<b>" + marker[33].nome + "</b>" + "<br>" + "<spam>"+ marker[33].gestao +"</spam>" + "<br>" + "<spam>" + marker[33].ensino + "</spam>" + "<br>" + "<spam>" + marker[33].fone + "</spam>");
    ...
    marker[34].fone = "(51) 32864008";
    marker[34].bindPopup("<b>" + marker[34].nome + "</b>" + "<br>" + "<spam>"+ marker[34].gestao +"</spam>" + "<br>" + "<spam>" + marker[34].ensino + "</spam>" + "<br>" + "<spam>" + marker[34].fone + "</spam>");
    ...
    marker[35].fone = "(sem info)";
    marker[35].bindPopup("<b>" + marker[35].nome + "</b>" + "<br>" + "<spam>"+ marker[35].gestao +"</spam>" + "<br>" + "<spam>" + marker[35].ensino + "</spam>" + "<br>" + "<spam>" + marker[35].fone + "</spam>");
    ...
    marker[36].fone = "(51) 32218347";
    marker[36].bindPopup("<b>" + marker[36].nome + "</b>" + "<br>" + "<spam>"+ marker[36].gestao +"</spam>" + "<br>" + "<spam>" + marker[36].ensino + "</spam>" + "<br>" + "<spam>" + marker[36].fone + "</spam>");
    ...
    marker[37].gestao = "privada";
    marker[37].ensino = ["Infantil", "Fundamental", "Médio"];
    ...
    marker[38].gestao = "privada";
    marker[38].ensino = ["Infantil"];
    ...
    marker[39].gestao = "privada";
    marker[39].ensino = ["Infantil", "Fundamental", "Médio"];
    ...
    marker[40].gestao = "privada";
    marker[40].ensino = ["Infantil"];
    ...
    marker[41].gestao = "privada";
    marker[41].ensino = ["Médio"];
    ...
    marker[42].gestao = "privada";
    marker[42].ensino = ["Profissional"];
    ...
    marker[43].gestao = "privada";
    marker[43].ensino = ["Profissional"];
    ...
    marker[44].gestao = "privada";
    marker[44].ensino = ["Infantil"];
    ...
    marker[50].ensino = ["Fundamental", "EJA"];
    ...
    marker[51].gestao = "privada";
    marker[51].ensino = ["Infantil", "Fundamental"];
    ...
    marker[52].ensino = ["Infantil", "Fundamental", "Médio"];
